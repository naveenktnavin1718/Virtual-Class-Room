...
<html>
    ...
    <body background="images/ex4.jpg">
        <header id="top">
        ...
        <%
        try{
            ResultSet rs=SqlUtil.retrieve("select * from studenttab order by course"); 
            if(rs!=null)
            {%>
                <table class="table table-sm table-dark table-striped" id="a1">
                      <thead>
                        <tr>
                          <th scope="col" width="10px">S_No</th>
                          <th scope="col" width="170px">Name</th>
                          <th scope="col" width="200px" >Mail-Id</th>
                          <th scope="col" width="100px" >DEPT</th>
                          <th scope="col" width="100px">Mobile_No</th>
                          <th scope="col" width="170px" >Address</th>
                          <th scope="col" width="200px">Register_No</th>
                        </tr>
                      </thead>
                      <tbody>
                <% int i=1;          
                ...
                {%>
                        ...
                        <tr>
                            ...
                            <td><%out.print(rs.getString("emailid"));%></td>
                          <td><%out.print(rs.getString("course"));%></td>
                          <td><%out.print(rs.getString("phone"));%></td>
                          <td><%out.print(rs.getString("address"));%></td>
                          <td><%out.print(rs.getString("regno"));%></td>
                        </tr>
                <%   i++; 
                }
                %>
        ...
        try{
            ...
            if(rs!=null)
            {%>
                <table class="table table-sm table-dark table-striped" id="a2">
                      <thead>
                        <tr>
          ...
          try{
            ...
            if(rs!=null)
            {%>
                <table class="table table-sm table-dark table-striped" id="a3">
                      <thead>
                        <tr>
                          <th scope="col">S_No</th>
                          <th scope="col">Question</th>
        ...
        try{
            ...
            if(rs!=null)
            {%>
                <table class="table table-sm table-dark table-striped" id="a4">
                      <thead>
                        <tr>
                          <th scope="col">S_No</th>
                          <th scope="col">Question</th>
        ...
        try{
            ...
            if(rs!=null)
            {%>
                <table class="table table-sm table-dark table-striped" id="a5">
                      <thead>
                        <tr>
                          <th scope="col">S_No</th>
                          <th scope="col">Question</th>
