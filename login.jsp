...
<body class="background" background="images/ex2.jpg"> 
    <div id="id01">
   ...
   <br>
      ...
      &nbsp;&nbsp<button type="submit" id="login">Login</button>
    </div>
    
            &nbsp;&nbsp;<button type="button" onclick="window.location.href='examindex.jsp'" class="cancelbtn">Cancel</button>
